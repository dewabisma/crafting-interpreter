...
public class Scanner {
    ...
    private boolean isAtEnd() {
        // If current index of char is >= length source, it means
        // we are at the end of the raw source code line
        return current >= source.length();
    }

    /**
     * Advance read the char at current index
     * then increment the current index by 1
     * So later on the next loop will start at the next char
     *
     * @return the char at current index of source code current line
     */
